          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-6 pr-3 py-3 border rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent font-mono text-sm transition-all ${
                  slugError
