...
function MetaRow({ icon, children }: { icon: React.ReactNode; children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-3 text-sm text-slate-700 dark:text-slate-300">
      <span className="flex h-[18px] w-[18px] flex-shrink-0 items-center justify-center text-slate-400">
        {icon}
      </span>
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <h3 className="mt-3 break-words text-xl font-bold leading-snug text-slate-900 dark:text-slate-100">
          {event.title}
        </h3>
        <div
