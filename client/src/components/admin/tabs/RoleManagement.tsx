          ...
          <table className="min-w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-700">
                ...
                <th className="text-left px-3 py-2 text-xs font-semibold text-slate-500 dark:text-slate-400 w-36">
                  이름
                </th>
                <th className="text-left px-3 py-2 text-xs font-semibold text-slate-500 dark:text-slate-400">
                  설명
                </th>
                <th className="text-left px-3 py-2 text-xs font-semibold text-slate-500 dark:text-slate-400 w-20">
                  상태
                </th>
