          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
                {isDragOver ? '파일을 여기에 놓으세요' : '여기로 끌어다 놓거나, 아래에서 고르세요'}
              </p>
            ...
            <button
              ...
              className="rounded-md border border-primary-300 bg-white px-3.5 py-2 text-sm font-semibold text-primary-600 transition-colors hover:bg-primary-50 dark:border-primary-700 dark:bg-slate-700 dark:text-primary-400 dark:hover:bg-primary-900/20"
            >
              파일 선택
            </button>
          </div>
