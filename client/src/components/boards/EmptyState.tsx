    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-6">
        ...
        {onClearTags && (
          <button
            onClick={onClearTags}
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
          >
            태그 필터 초기화
          </button>
        )}
