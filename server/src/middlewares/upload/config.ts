...
// 허용 확장자·파일 크기·이미지 개수는 settingsCache 에서 동적으로 읽고, 아래 상수는 폴백이다.
...
// 인라인 서빙되는 이미지의 실제 타입 검증용. 문서·압축은 다운로드 전용이라 내용 검증을 하지 않는다.
...
export const UPLOAD_DIRS = {
  ...
  // 첨부 이미지 썸네일 캐시(요청 시점 지연 생성). 지워도 다시 만들어진다.
  THUMBS: path.join(__dirname, '../../../uploads/thumbs'),
};
